...
public class threedashthree {
	public static void main(String[] args) {
		...
		//reads users input for (a) in a integer value from the console
		int a = input.nextInt() ;
				
		//Prompt the user to enter b, and assign to b.
		System.out.print("Enter b: ") ;
		//reads users input for (b) in a integer value from the console
		int b = input.nextInt() ;
				
		//Prompt the user to enter c, and assign to c.
		System.out.print("Enter c: ") ;
		//reads users input for (c) in a integer value from the console
		int c = input.nextInt() ;
				
		//Prompt the user to enter d, and assign to d.
		System.out.print("Enter d: ") ;
		//reads users input for (d) in a integer value from the console
		int d = input.nextInt() ;
		...
		if ( (a * d - b * c) == 0 ) {
			...
			//reads users input for (e) in a integer value from the console
			int e = input.nextInt() ;
		
			//Prompt the user to enter f, and assign to f.
			System.out.print("Enter f: ") ;
			//reads users input for (f) in a integer value from the console
			int f = input.nextInt() ;
